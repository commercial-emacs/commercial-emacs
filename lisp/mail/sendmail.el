...
;;;###autoload
(defcustom mail-header-separator (purify-if-dumping "--text follows this line--")
...
;;;###autoload
(defcustom mail-personal-alias-file (purify-if-dumping "~/.mailrc")
...
;;;###autoload
(defcustom mail-signature-file (purify-if-dumping "~/.signature")
  "File containing the text inserted at end of mail buffer."
  :type 'file)

;;;###autoload
(defcustom mail-default-directory (purify-if-dumping "~/")
