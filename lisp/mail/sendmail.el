...
;;;###autoload
(defcustom mail-header-separator (purecopy-maybe "--text follows this line--")
...
;;;###autoload
(defcustom mail-personal-alias-file (purecopy-maybe "~/.mailrc")
...
;;;###autoload
(defcustom mail-signature-file (purecopy-maybe "~/.signature")
  "File containing the text inserted at end of mail buffer."
  :type 'file)

;;;###autoload
(defcustom mail-default-directory (purecopy-maybe "~/")
