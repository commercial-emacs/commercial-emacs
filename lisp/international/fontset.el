...
(setq font-encoding-alist
      (mapcar (lambda (arg)
		(cons (purify-if-dumping (car arg)) (cdr arg)))
...
(setq x-pixel-size-width-font-regexp
      (purify-if-dumping "gb2312\\|gbk\\|gb18030\\|jisx0208\\|ksc5601\\|cns11643\\|big5"))

;; These fonts require vertical centering.
(setq vertical-centering-font-regexp
      (purify-if-dumping "gb2312\\|gbk\\|gb18030\\|jisx0208\\|jisx0212\\|ksc5601\\|cns11643\\|big5"))
...
(defvar standard-fontset-spec
  (purify-if-dumping "-*-fixed-medium-r-normal-*-16-*-*-*-*-*-fontset-standard")
