...
(defcustom x-dnd-types-alist
  `((,(purify-if-dumping "text/uri-list") . x-dnd-handle-uri-list)
    (,(purify-if-dumping "text/x-moz-url") . x-dnd-handle-moz-url)
    (,(purify-if-dumping "_NETSCAPE_URL") . x-dnd-handle-uri-list)
    (,(purify-if-dumping "FILE_NAME") . x-dnd-handle-file-name)
    (,(purify-if-dumping "UTF8_STRING") . x-dnd-insert-utf8-text)
    (,(purify-if-dumping "text/plain;charset=UTF-8") . x-dnd-insert-utf8-text)
    (,(purify-if-dumping "text/plain;charset=utf-8") . x-dnd-insert-utf8-text)
    (,(purify-if-dumping "text/unicode") . x-dnd-insert-utf16-text)
    (,(purify-if-dumping "text/plain") . dnd-insert-text)
    (,(purify-if-dumping "COMPOUND_TEXT") . x-dnd-insert-ctext)
    (,(purify-if-dumping "STRING") . dnd-insert-text)
    (,(purify-if-dumping "TEXT")   . dnd-insert-text)
    (,(purify-if-dumping "DndTypeFile") . x-dnd-handle-offix-file)
    (,(purify-if-dumping "DndTypeFiles") . x-dnd-handle-offix-files)
    (,(purify-if-dumping "DndTypeText") . dnd-insert-text))
