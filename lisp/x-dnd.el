...
(defcustom x-dnd-types-alist
  `((,(purecopy-maybe "text/uri-list") . x-dnd-handle-uri-list)
    (,(purecopy-maybe "text/x-moz-url") . x-dnd-handle-moz-url)
    (,(purecopy-maybe "_NETSCAPE_URL") . x-dnd-handle-uri-list)
    (,(purecopy-maybe "FILE_NAME") . x-dnd-handle-file-name)
    (,(purecopy-maybe "UTF8_STRING") . x-dnd-insert-utf8-text)
    (,(purecopy-maybe "text/plain;charset=UTF-8") . x-dnd-insert-utf8-text)
    (,(purecopy-maybe "text/plain;charset=utf-8") . x-dnd-insert-utf8-text)
    (,(purecopy-maybe "text/unicode") . x-dnd-insert-utf16-text)
    (,(purecopy-maybe "text/plain") . dnd-insert-text)
    (,(purecopy-maybe "COMPOUND_TEXT") . x-dnd-insert-ctext)
    (,(purecopy-maybe "STRING") . dnd-insert-text)
    (,(purecopy-maybe "TEXT")   . dnd-insert-text)
    (,(purecopy-maybe "DndTypeFile") . x-dnd-handle-offix-file)
    (,(purecopy-maybe "DndTypeFiles") . x-dnd-handle-offix-files)
    (,(purecopy-maybe "DndTypeText") . dnd-insert-text))
