...
syms_of_keymap (void)
{
  ...
  exclude_keys = list
    (Fcons (build_c_string ("DEL"), build_c_string ("\\d")),
     Fcons (build_c_string ("TAB"), build_c_string ("\\t")),
     Fcons (build_c_string ("RET"), build_c_string ("\\r")),
     Fcons (build_c_string ("ESC"), build_c_string ("\\e")),
     Fcons (build_c_string ("SPC"), build_c_string (" ")));
